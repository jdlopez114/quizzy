...
//                new Question(R.string.question_restrictive_access_level, false),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = intent.getStringExtra(MainActivity.FILLER_STRING);
        TextView userNameView = (TextView) findViewById(R.id.quizzer_name);
        userNameView.setText("Quiz for: " + name);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.true_btn:
                ...
                Toast.makeText(this, "You've answered " + score + "/" + questionBank.length + " questions correct!", Toast.LENGTH_LONG).show();
                break;
            ...
            case R.id.cheat_button:
                Toast.makeText(this, "Now Cheating", Toast.LENGTH_LONG).show();
